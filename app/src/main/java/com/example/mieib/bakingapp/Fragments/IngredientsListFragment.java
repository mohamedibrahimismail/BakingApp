package com.example.mieib.bakingapp.Fragments;
...
import com.example.mieib.bakingapp.Adapters.RecyclerIngredientsAdapter;
import com.example.mieib.bakingapp.Model.Ingredient;
import com.example.mieib.bakingapp.R;
import com.example.mieib.bakingapp.Utilities.NetworkUtils;
import com.example.mieib.bakingapp.Widget.IngredientsWidgetProvider;
...
public class IngredientsListFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Ingredient>> {
    ...
    @Override
    public Loader<List<com.example.mieib.bakingapp.Model.Ingredient>> onCreateLoader(int id, Bundle args) {
        return new AsyncTaskLoader<List<com.example.mieib.bakingapp.Model.Ingredient>>(getContext()) {
            @Override
            ...
            @Override
            public List<com.example.mieib.bakingapp.Model.Ingredient> loadInBackground() {
                List<com.example.mieib.bakingapp.Model.Ingredient> ingredients = new ArrayList<>();
                try {
